...
object MeshBlur : IRenderer {
    ...
    fun blur(pos1: Vec2, pos2: Vec2, strength: Int) {
        ...
        val blurViewportSizeD = Vec2.create(viewportSize.x * 0.5, viewportSize.y * 0.5)
        ...
        blurShader.uniforms {
            bindlessSampler("u_INPUT_TEXTURE", fbo0.attachments[FramebufferAttachment.Color0]!!)
        ...
        repeat((strength - 1).coerceAtLeast(0)) {
            blurShader.uniforms {
                bindlessSampler("u_INPUT_TEXTURE", fbo1.attachments[FramebufferAttachment.Color0]!!)
